        ...
        <div>
            <div className='flex items-center justify-between md:px-32 px-8 md:flex-row flex-col py-24 gap-10'>
                <motion.div variants={fadeIn("up", 0.2)} initial='hidden' whileInView={"show"} viewport={{ once: false, amount: 0.7 }} className='space-y-3'>
                    ...
                    <p className='text-[#0C7E81] text-4xl font-bold'>Superior College Manga Campus</p>
                    <p className='text-gray-600 text-[13px]'>We are committed to enhancing the potential of our students, faculty,
                        ...
                        value to our nation and humanity.</p>
                    <br />
