        ...
        <div className='bg-gray-100'>
            <div className='md:px-32 px-8 py-24 grid md:grid-cols-2 grid-cols-1 gap-12'>
                <div className='space-y-2'>
                    ...
                    <h2 className='text-3xl font-bold text-[#0C7E81]'>Join Superior College Manga Campus to build the superior Pakistan</h2>
                    <p className='text-[13px] text-gray-700'>Superior College Manga Campus prepare students to be leaders in their professions.  Students have easy access to online admission in any course.</p>
