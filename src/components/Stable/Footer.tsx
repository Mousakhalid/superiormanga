                ...
                <div className='grid md:grid-cols-3 gap-8'>
                    <div className='space-y-6'>
                        <div className='flex gap-5 items-center'>
                            ...
                            <p className='text-xl font-serif font-medium text-gray-50'>Superior College Manga <br /> Campus</p>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className='text-gray-50 text-[12px]'>
                            ...
                            <li><strong>Email:</strong> info@superiormanga.com</li>
                            <li><strong>Address:</strong>Manga Lahore</li>
