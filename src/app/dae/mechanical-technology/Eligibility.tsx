        ...
        <div className='bg-gray-100'>
            <div className='grid md:grid-cols-3 grid-cols-1 gap-10 md:px-32 px-8 py-20'>
                <div className='bg-[#0C7E81]'>
                    <div className=' py-4'>
                        <h2 className='text-2xl font-bold text-gray-50 text-center'>Subjects DAE-<br />Mechanical Engineering 1-2 Years</h2>
                ...
                <div className='bg-yellow-500'>
                    <div className=' py-4'>
                        <h2 className='text-2xl font-bold text-[#0C7E81] text-center'>Subjects DAE-<br />Mechanical Engineering III</h2>
                        <ul className='list-disc text-[13px] text-gray-800 px-8 py-3'>
                            ...
                            <li>Basic Engineering Design</li>
                            <li>CAD</li>
                        </ul>
                    </div>
                </div>
